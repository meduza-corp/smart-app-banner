...
SmartBanner.prototype = {
	...
	create: function() {
		...
		var inStore = '<span class="smartbanner-in-store">' + this.options.price[this.type] + '</span>' + ' — ' + this.options.store[this.type];
		var icon;
	...
	close: function() {
		this.hide();
		cookie.set('smartbanner-closed-' + this.options.uniqueId, 'true', {
			path: '/',
	...
	install: function() {
		this.hide();
		cookie.set('smartbanner-installed-' + this.options.uniqueId, 'true', {
			path: '/',
